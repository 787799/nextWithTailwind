export default function WeatherReport() {
  return (
    <>
      {/* <div class=" bg-slate-800 backdrop-blur-sm mx-auto shadow rounded pb-4 h-[400px] w-full text-white flex justify-center items-center flex-col bg-cover">
        <div class="mt-2 p-4 border-b border-grey-light  text-center">
          <span class="text-4xl font-thin">Mountain View, US</span>
          <span class="hidden sm:inline-block align-bottom text-xs">
            ( 94041 )
          </span>
        </div>
        ...
        <div class="flex justify-center">
          <div class="text-center p-2">
            <div class="text-lg text-grey-light">
              ...
              <span class="text-center text-5xl text-white mx-6  font-thin">
                49˚F
              </span>
      ...
      <div class="flex flex-row bg-[url('https://www.pixelstalk.net/wp-content/uploads/2016/10/Cloud-Wallpapers-HD.jpg')]  items-start p-10 pl-10 justify-around w-full min-h-full text-gray-700 p-2 bg-cover ">
        <div class="w-[40%] text-white my-10  bg-transparent p-10 ">
          <h1 className=" w-full h-100 py-4 text-start font-bold text-4xl my-4 ">
            Weather Report
          </h1>
          <div class="flex justify-between">
            <div class="flex flex-col">
              <span class="text-5xl font-bold">29°C</span>
              <span class="font-semibold mt-1 text-white">Mudjimba, QLD</span>
            </div>
            <svg
        ...
        <div class="flex flex-col   space-y-6 w-[40%]  bg-white p-10 mt-10 rounded-xl ring-8 ring-white ring-opacity-40">
