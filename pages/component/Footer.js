export default function Footer() {
  return (
    <>
      <footer class="bg-slate-800 text-center text-white dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div class="bg-slate-800 p-6 text-center border-t-2 border-white dark:bg-neutral-700">
